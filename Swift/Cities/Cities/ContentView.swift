...
private let URL_NO_MAIN_IMAGE = "https://firebasestorage.googleapis.com/v0/b/cities-99401.appspot.com/o/ProgramImage%2F3.jpg?alt=media&token=6feac294-d510-4f07-9e99-579ca375cf05"
private let URL_FAVOURITE = "https://firebasestorage.googleapis.com/v0/b/cities-99401.appspot.com/o/ProgramImage%2F1.jpg?alt=media&token=9dbe570b-cefc-4581-a95c-2f6a6e6cdaef"
private let URL_NO_FAVOURITE = "https://firebasestorage.googleapis.com/v0/b/cities-99401.appspot.com/o/ProgramImage%2Fpng-transparent-commercial-building-skyscraper-buildings-building-photography-logo.png?alt=media&token=b892b4b0-bf83-4d31-b39f-602e5b6e8cae"

private let FIELDS = ["Region","District","Founded","Area","Elevation","Population","TimeZone","PostalCode","AreaCode","LicensePlate"]
...
// Функция для получения цветов флага
func flagColorsButton() -> [Color] {
    return [Color.red, Color.red, Color(red: 0.2, green: 0.5, blue: 0.3)]
}
                    ...
                    Text("Вход", tableName: nil, bundle: Bundle.main, comment: "") // Пример параметров конструктора Text
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 8)
                                .fill(LinearGradient(gradient: Gradient(colors: flagColorsButton()), startPoint: .top, endPoint: .bottom))
                        )
                        .cornerRadius(10)
                }
...
struct ObjectListView: View {
    ...
    var body: some View {
        VStack {
            Text("Список городов", tableName: nil, bundle: Bundle.main, comment: "")
                .foregroundColor(.black) // Цвет текста
                .padding(.horizontal) // Отступы внутри кнопки
                .background(Color.white) // Цвет фона кнопки
                .cornerRadius(10) // Радиус скругления углов, делает кнопку круглой
            ...
            Button(action: {
                ...
                Text("Профиль города", tableName: nil, bundle: Bundle.main, comment: nil)
                    .foregroundColor(.white) // Цвет текста
                    .padding() // Отступы внутри кнопки
                    .background(
                        RoundedRectangle(cornerRadius: 8)
...
struct UserProfileView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("Профиль города", tableName: nil, bundle: Bundle.main, comment: "") // Пример параметров конструктора Text
